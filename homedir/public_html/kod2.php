<?php 
    ...
    $sql .= " CONCAT( p2.ad, ' ', p2.soyad ) as guncelleyen, a.guncelleme_tarihi  FROM kod2 AS a";
 ...
 <div class="row">
        <div class="card mt-2 border-secondary">
            <div class="card-header d-flex justify-content-between border-secondary">
                <h5 >
                    <i class="fa-solid fa-building"></i> Kod 2 Kayıtları
                </h5> 
                <div>
                                            ...
                                            <div class="dropdown-menu">
                                               <?php if (in_array(DEPO_GUNCELLE, $_SESSION['sayfa_idler'])) { ?>
                                                ...
                                                <?php if(in_array(DEPO_SIL, $_SESSION['sayfa_idler'])){ ?>
                                                    <a href="/index.php?url=kod2_db_islem&islem=kod_sil&id=<?php echo $kod['id']; ?>" 
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="width:450px;">
                    <div class="modal-header bg-light pt-1 pb-1">
                        <h4 class="modal-title" id="myCenterModalLabel">Kod 2 Ekle</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-4">
                        <form action="/index.php?url=kod2_db_islem" method="POST" id="kod-ekle-form" class="row g-3 needs-validation">
    ...
    <div class="modal fade" id="kod-guncelle-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="guncelleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="width:450px;">
                <div class="modal-header bg-light pt-1 pb-1">
                    <h4 class="modal-title" id="guncelleModalLabel">Kod 2 Güncelle</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form action="/index.php?url=kod2_db_islem&islem=kod_guncelle" method="POST" id="kod-guncelle-form" class="row g-3 needs-validation">
                        <input type="hidden" name="kod_id" id="guncelleKodKoduId">
                        <div class="row mb-1" style="padding-right: 0px;">
                            <div class="col-md-12" style="padding-right: 0px;">
                                <label for="guncelleKodTanimi" class="form-label">Tanım</label>
                                <input type="text" class="form-control" id="guncelleKodTanimi" name="kod_tanimi" placeholder="Kod 2 Tanımı Girin">
                            </div>
                        </div>
                        <div class="text-end">
                            <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-dismiss="modal">İptal</button>
   ...
   <script> 
        $(document).ready(function() {
            ...
            $('.guncelleButonu').click(function() {
                ...
                $.ajax({
                    url: '/index.php?url=kod2_db_islem&islem=get_kod',
                    type: 'POST',
                    data: { id: kodId },
                    dataType: 'json',
            ...
            $('#kod-guncelle-form').submit(function(e) {
                ...
                if (aciklama === '') {
                    showErrorToast('Kod 2 tanımı zorunludur.');
                    e.preventDefault();
                    return false;
                }
            }); 
