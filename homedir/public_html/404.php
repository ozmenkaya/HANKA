<body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">Görünüşe göre yanlış bir yola sapmış olabilirsiniz. Endişelenmeyin. 
                                        Bu hepimizin başına gelir.
                                        İşte tekrar yola koyulmanıza yardımcı olacak küçük bir ipucu.</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Ana Sayfaya<a href="/" class="text-white ms-1"><b>Geri Dön</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2015 - <script>document.write(new Date().getFullYear())</script>2025 © UBold theme by <a href="" class="text-white-50">Coderthemes</a> 
        </footer>
