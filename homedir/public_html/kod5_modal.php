<?php 
       $sth = $conn->prepare('SELECT id, aciklama FROM kod5 WHERE firma_id = :firma_id');
       $sth->bindParam('firma_id', $_SESSION['firma_id']);
       $sth->execute();
       $birimler = $sth->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="modal fade" id="kod5Modal" tabindex="-1" aria-labelledby="kodKoduLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="padding-top:10px;padding-bottom:10px">
                    <h5 class="modal-title" id="kodKoduLabel">Kod 5 Listesi</h5>
