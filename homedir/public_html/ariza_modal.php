<!-- ariza Modal -->
<div class="modal fade" id="ariza-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="arizaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light pt-1 pb-1">
                <h4 class="col-md-11 modal-title text-center" id="arizaModalLabel">Ariza Loglar</h4>
                <button type="button" class="col-md-1 btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body pt-1 p-3"> 
                    <div class="row">
                        <table class="table table-sm table-bordered" id="arizaTablosu">
                            <thead>
                                <tr> 
