    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
            tools: [
                {
                    name: "search_code",
                    description: "Semantik kod araması - HANKA kod tabanında RAG ile arama yap. PHP dosyalarında pattern, fonksiyon, class arar.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description: "Arama sorgusu (örn: 'PDO prepared statement', 'firma_id kontrolü', 'JSON veriler')",
                            },
                            file_type: {
                                type: "string",
                                description: "Dosya tipi filtresi (backend_api, view, agent, core, form, modal)",
                                enum: ["backend_api", "view", "agent", "core", "form", "modal", "javascript"],
                            },
                            n_results: {
                                type: "number",
                ...
                {
                    name: "get_rag_stats",
                    description: "RAG collection istatistikleri - Index'lenen dosya sayıları, tipleri",
                    inputSchema: {
                        type: "object",
                        properties: {},
                    },
                },
                {
                    ...
                    description: "Geliştirme kararlarında ara - Multi-tenant, PDO, security gibi teknik kararları bul",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description: "Karar sorgusu (örn: 'multi-tenant', 'PDO', 'security')",
                            },
                        },
                        required: ["query"],
                    },
                },
                {
                    ...
                    description: "Kod pattern'lerinde ara - CRUD, AJAX, MES pattern'leri bul",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description: "Pattern sorgusu (örn: 'CRUD', 'AJAX', 'MES', 'JSON')",
                            },
                        },
                        required: ["query"],
                    },
                },
                {
                    ...
                    description: "Geçmiş bug fix'lerde ara - Benzer hataların çözümlerini bul",
                    inputSchema: {
                        type: "object",
                        properties: {
                            query: {
                                type: "string",
                                description: "Bug sorgusu (örn: 'AlertAgent', 'MySQLi', 'JSON_EXTRACT')",
                            },
                        },
                        required: ["query"],
                    },
                },
                {
                    ...
                    description: "Memory istatistikleri - Toplam decision, pattern, bug fix, learning sayıları",
                    inputSchema: {
                        type: "object",
                        properties: {},
                    },
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case "search_code": {
                        const { query, file_type, n_results = 5 } = args;
